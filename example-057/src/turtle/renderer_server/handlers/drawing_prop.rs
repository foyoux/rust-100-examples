use crate::turtle::ipc_protocol::{ServerOneshotSender, ServerResponse, DrawingProp, DrawingPropValue};
...
pub(crate) fn drawing_prop(
    ...
    let value = match prop {
        ...
        Size => DrawingPropValue::Size(crate::turtle::Size {width: drawing.width, height: drawing.height}),
...
pub(crate) fn reset_drawing_prop(
    ...
    modify_drawing(&mut drawing, event_loop, match prop {
        ...
        Size => DrawingPropValue::Size(crate::turtle::Size {
...
fn modify_drawing(
    ...
    match prop_value {
        ...
        Size(crate::turtle::Size {width, height}) => {
            drawing.width = width;
